...
def game_loop():
    global high_score, change_to, direction, fruit_position, snake_position, snake_body, fruit_spawn, score, snake_speed, window_x, window_y, game_window, white  # Declare global variables
